...
- Update Manjaro logo (#75)
- [**breaking**] Config unification, CLI options, and raw logos (#62, #63, #61)
- Add winget and chocolatey package counts
- [**breaking**] Support all libmacchina package managers
- Add finix logo (#76)
...
- Simplify helpers and pass custom logos explicitly
...
- Fix render workflow failing
- Update typst render workflow
- Force color output during logo rendering
- Switch away from actions-rs
